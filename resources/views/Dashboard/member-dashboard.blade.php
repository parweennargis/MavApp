@include('member.layout')
    ...
    <ul class="info-blocks">
        ...
        <li class="bg-{{ $category->color }}">
            <div class="top-info">
                <a href="{{ url('/member/question/summary/' . $category->name ) }}">{{ $category->name }}</a>
            </div>
            <a href="#"><i class="icon-{{ $category->icon }}"></i></a>
            <span class="bottom-info bg-danger">{{ rand(1,20) }} users in progress</span>
        </li>
        @endforeach
    </ul>
